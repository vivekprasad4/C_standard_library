...
printf("\n|     %d    |%s%*s |%*s%d%*s",o,b[j].title,width,space,width3,space,b[j].id,width4,verline);
j++;
o++;
}
...
printf("\n|    %d   |%s%*s%*s%d%*s%*s%d%*s",o,s[j].name,width,verline,width5,space,s[j].level,width2,verline,width3,space,s[j].idd,width4,verline);
j++;
o++;
}
